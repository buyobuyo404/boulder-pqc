...
//
//// TestMain: 若被测试的方法依赖某些环境, 则需要首先初始化环境,
//// 测试结束后，又需要做清理工作(例如关闭连接)等等可以用TestMain()
//func func1() *Certificate {
...
//}
//
//func TestNewProfilePoliciesPQC(t *testing.T) {
...
//}
//
//func TestRequestValidPQC(t *testing.T) {
//	fc := clock.NewFake()
//	fc.Add(time.Hour * 24)
//	tests := []struct {
//		name          string
...
//		},
//		{
//			name:          "cannot sign falcon512",
//			profile:       &Profile{},
//			request:       &IssuanceRequest{PublicKey: &falcon512.PublicKey{}},
//			expectedError: "cannot sign falcon512 public keys",
//		},
//		{
...
//}
//
//func TestGenerateTemplatePQC(t *testing.T) {
//	tests := []struct {
//		name             string
//		profile          *Profile
//		expectedTemplate *x509.Certificate
...
//}
//
//func TestNewIssuerUnsupportedKeyTypePQC(t *testing.T) {
//	_, err := NewIssuer(
//		&Certificate{
//			Certificate: &x509.Certificate{
...
//}
//
//func TestNewIssuerOCSPOnlyPQC(t *testing.T) {
//	p := defaultProfile()
//	p.useForRSALeaves = false
//	p.useForECDSALeaves = false
//	p.useForFalcon512Leaves = false
//	p.useForFalcon1024Leaves = false
//	p.useForDilithium2Leaves = false
//	p.useForDilithium3Leaves = false
//	p.useForDilithium5Leaves = false
//	p.useForDilithium2AESLeaves = false
//	p.useForDilithium3AESLeaves = false
//	p.useForDilithium5AESLeaves = false
//	p.useForRainbowIIIClassicLeaves = false
//	p.useForRainbowIIICircumzenithalLeaves = false
//	p.useForRainbowIIICompressedLeaves = false
//	p.useForRainbowVClassicLeaves = false
//	p.useForRainbowVCircumzenithalLeaves = false
//	p.useForRainbowVCompressedLeaves = false
//
//	_, err := NewIssuer(
//		&Certificate{
//			Certificate: &x509.Certificate{
